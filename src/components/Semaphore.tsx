...
export function Semaphore({ lightsActive }: SemaphoreProps) {
  return (
    <div className="flex flex-row items-center justify-center gap-2 sm:gap-6 p-4 sm:p-8 bg-neutral-900/80 border-y-4 border-neutral-800 shadow-2xl relative overflow-hidden">
      {[...Array(5)].map((_, i) => (
      ...
      <div className="absolute inset-0 opacity-10 pointer-events-none bg-[linear-gradient(90deg,transparent_95%,rgba(255,255,255,0.1)_100%)] bg-[length:20px_100%]" />
    </div>
  );
}