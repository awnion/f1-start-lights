    ...
    <div className="w-full flex flex-row items-center justify-center gap-1.5 sm:gap-4 md:gap-5 p-4 pt-6 sm:pb-10 md:pb-14 bg-neutral-900/90 border-y-4 border-neutral-800 shadow-[0_0_50px_rgba(0,0,0,0.5)] relative overflow-hidden">
      {[...Array(5)].map((_, i) => (
        <div key={i} className="flex flex-col gap-2 sm:gap-4">
          ...
          <div className="w-12 sm:w-20 md:w-28 lg:w-32 h-28 sm:h-44 md:h-56 lg:h-64 bg-neutral-950 rounded-sm sm:rounded-lg border-2 border-neutral-800 flex flex-col items-center justify-around py-3 sm:py-5 shadow-inner transition-none">
